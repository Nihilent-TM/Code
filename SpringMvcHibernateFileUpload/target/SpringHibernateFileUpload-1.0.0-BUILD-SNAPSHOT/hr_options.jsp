...
.button1 {
   ...
   background: #14b351;
   background: -webkit-gradient(linear, left top, left bottom, from(#14b351), to(#14b351));
   background: -webkit-linear-gradient(top, #14b351, #14b351);
   background: -moz-linear-gradient(top, #14b351, #14b351);
   background: -ms-linear-gradient(top, #14b351, #14b351);
   background: -o-linear-gradient(top, #14b351, #14b351);
   background-image: -ms-linear-gradient(top, #14b351 0%, #14b351 100%);
   padding: 13px 26px;
...
.button2:hover {
   ...
   border: 1px solid #ffffff;
   background: #e04545;
   background: -webkit-gradient(linear, left top, left bottom, from(#e04545), to(#e04545));
   background: -webkit-linear-gradient(top, #e04545, #e04545);
   background: -moz-linear-gradient(top, #e04545, #e04545);
   background: -ms-linear-gradient(top, #e04545, #e04545);
   background: -o-linear-gradient(top, #e04545, #e04545);
   background-image: -ms-linear-gradient(top, #e04545 0%, #e04545 100%);
   padding: 10.5px 21px;
   -webkit-border-radius: 3px;
   -moz-border-radius: 3px;
   border-radius: 3px;
 ...
 <!-- Main Content of Page -->
        ...
        <tr>
          ...
          <td height="502" valign="top">
            <div> <br> <br> <br> <a href='hr_add_can.jsp' class='button1'>Add Candidate Profile</a> <br> <br> <br> <br> <a href='hr_edit_can.jsp' class='button2'>Edit Candidate Profile</a> <br> <br> <br> <br> <a href='hr_remove_can.jsp' class='button3'>Remove Candidate Profile</a> <br> <br> <br> <br> <a href='search.jsp' class='button4'>Multi-Criteria Search</a> </div>
          </td>
        </tr>

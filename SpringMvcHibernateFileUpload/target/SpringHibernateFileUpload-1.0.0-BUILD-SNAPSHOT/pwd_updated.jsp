      ...
      <!--DWLayoutTable-->
        <tr>
          ...
          <td width="550" height="91" >
            <br> 
            <img src="images/update_pwd.jpg" alt="Update Password" height ="30" width= "350">
          </td>
 ...
 <!-- Main Content of Page -->
        ...
        <tr>
          ...
          <td height="502" valign="top">
            <div align ="center"> <h2> Password Updated! </h2> <br> <br> <br> <br> <br> <br> <br> <br> <a href='admin_options.jsp' class='button2'>Go Back to Options</a> </div>
          </td>
        </tr>

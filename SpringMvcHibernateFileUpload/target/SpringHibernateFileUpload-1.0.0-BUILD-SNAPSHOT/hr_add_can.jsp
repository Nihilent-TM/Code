      ...
      <!--DWLayoutTable-->
        <tr>
          ...
          <td width="550" height="91" >
            <br> 
            <img src="images/add_can.jpg" alt="Add a Candidate Profile" height ="30" width= "350">
          </td>
          <td width="87" height="91" background="images/nihilent_logo.gif"style="background-repeat:no-repeat" id="topimg"> </td>
        </tr>
 ...
 <!-- Main Content of Page -->
        ...
        <tr>
          ...
          <td height="502" valign="top">
            ...
            <form  action="userRegistration.jsp" class="form-container" method="post">
              <div class="form-title"><h2>Enter Candidate Details:</h2></div><br />
              <div class="form-title">First Name</div>
              <input type="text" class="form-field" name="firstname" value="" /><br />
              ...
              <input class="form-field" type="text" name="num" /><br />

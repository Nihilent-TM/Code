      ...
      <!--DWLayoutTable-->
        <tr>
          ...
          <td width="550" height="91" >
            <br> 
            <img src="images/remove_acc.jpg" alt="Delete an Account" height ="30" width= "330">
          </td>
 ...
 <!-- Main Content of Page -->
        ...
        <tr>
          ...
          <td height="502" valign="top">
            <form class="form-container" action="remove_acc_back.jsp">
              <div class="form-title"><h2>Enter Username for Account to be removed:</h2></div> <br />

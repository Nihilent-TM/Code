...
String sql = "select * from user_detail where name=? and password=? and usertype=?";
...
{ 
	...
	if(name.equals(userdbName) && password.equals(userdbPsw) && usertype.equals(dbUsertype))
	{
		...
		else if(usertype.equals("H.R.Representative"))
		{
			response.sendRedirect("hr_options.jsp");
		}

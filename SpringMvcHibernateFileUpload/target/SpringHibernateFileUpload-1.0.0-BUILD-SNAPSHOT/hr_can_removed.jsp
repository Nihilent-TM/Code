      ...
      <!--DWLayoutTable-->
        <tr>
          ...
          <td width="550" height="91" >
            <br> 
            <img src="images/remove_can.jpg" alt="Remove a Candidate Profile" height ="30" width= "350">
          </td>
 ...
 <!-- Main Content of Page -->
        ...
        <tr>
          ...
          <td height="502" valign="top">
            <div align ="center"> <h2> Candidate Record Removed! </h2> <br> <br> <br> <br> <br> <br> <a href='hr_remove_can.jsp' class='button1'>Remove Another Candidate Profile</a> <br> <br> <br> <br> <a href='hr_options.jsp' class='button2'>Go Back to Options</a> </div>
          </td>
        </tr>

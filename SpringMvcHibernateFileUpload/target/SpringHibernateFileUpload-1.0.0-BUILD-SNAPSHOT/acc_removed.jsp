      ...
      <!--DWLayoutTable-->
        <tr>
          ...
          <td width="550" height="91" >
            <br> 
            <img src="images/remove_acc.jpg" alt="Remove Account" height ="30" width= "350">
          </td>
 ...
 <!-- Main Content of Page -->
        ...
        <tr>
          ...
          <td height="502" valign="top">
            <div align ="center"> <h2>  Account Removed! </h2> <br> <br> <br> <br> <br> <br> <a href='remove_acc.jsp' class='button1'>Remove Another Account</a> <br> <br> <br> <br> <a href='admin_options.jsp' class='button2'>Go Back to Options</a> </div>
          </td>
        </tr>

      ...
      <!--DWLayoutTable-->
        <tr>
          ...
          <td width="550" height="91" >
            <br> 
            <img src="images/create_acc.jpg" alt="Create a New Account" height ="30" width= "330">
          </td>
 ...
 <!-- Main Content of Page -->
        ...
        <tr>
          ...
          <td height="502" valign="top">
            <form action="account_add.jsp"class="form-container">
              <div class="form-title"><h2>Enter details for new Account:</h2></div> <br />

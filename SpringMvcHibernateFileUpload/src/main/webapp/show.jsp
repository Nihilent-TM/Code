...
<title>Admin Edit Candidate</title>
...
%> </td> 
        ...
        <tr>
          ...
          <td height="502" valign="top">
             <form action="editing.jsp" class="form-container">
             

              <div class="form-title"><h2>Enter Candidate Details:</h2></div><br />
              <div class="form-title">First Name</div>
              <input class="form-field" type="text" name="fname" /><br />
              <div class="form-title">Last Name</div>
              <input class="form-field" type="text" name="lname" /><br />
              <div class="form-title">Email</div>
              <input class="form-field" type="text" name="email_new" /><br />
              <div class="form-title">Contact Number</div>
              <input class="form-field" type="text" name="num_new" /><br />

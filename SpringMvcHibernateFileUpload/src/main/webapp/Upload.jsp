 ...
 <!-- Main Content of Page -->
        ...
        <tr>
          ...
          <td height="502" valign="top">
            ...
            <form  action="doUpload" class="form-container" method="post" enctype="multipart/form-data">

Upload Resume of <%=session.getAttribute("email")%>

       
              <div class="form-title">Resume (Word or PDF formats only)</div>

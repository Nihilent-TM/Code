...
<title>HR Remove Candidate</title>
      ...
      <!--DWLayoutTable-->
        <tr>
          ...
          <td width="550" height="91" >
            <br> 
            <img src="images/remove_can.jpg" alt="Remove a Candidate Profile" height ="30" width= "370">
          </td>
 ...
 <!-- Main Content of Page -->
        ...
        <tr>
          ...
          <td height="502" valign="top">
            <form class="form-container" action="remove_hr.jsp">
              <div class="form-title"><h2>Enter Email for a Profile to Remove:</h2></div> <br />

...
.form-container {
   ...
   background: #a756c7;
   background: -webkit-gradient(linear, left top, left bottom, from(#a756c7), to(#a756c7));
   background: -webkit-linear-gradient(top, #a756c7, #a756c7);
   background: -moz-linear-gradient(top, #a756c7, #a756c7);
   background: -ms-linear-gradient(top, #a756c7, #a756c7);
   background: -o-linear-gradient(top, #a756c7, #a756c7);
   background-image: -ms-linear-gradient(top, #a756c7 0%, #a756c7 100%);
      ...
      <!--DWLayoutTable-->
        <tr>
          ...
          <td width="550" height="91" >
            <br> 
            <img src="images/search.jpg" alt="Welcome to the Talent Management Portal" height ="30" width= "565">
          </td>
        ...
        <tr>
          ...
          <td height="502" valign="top">
            <form class="form-container">
              <div class="form-title"><h2>Enter Details for Search:</h2></div><br />
              <div class="form-title">Skills</div>
              <input class="form-field" type="text" name="skill1" /><br />
              <input class="form-field" type="text" name="skill2" /><br />
              <input class="form-field" type="text" name="skill3" /><br />
              <input class="form-field" type="text" name="skill4" /><br /> 
              <input class="form-field" type="text" name="skill5" /><br />               
              <div class="form-title">Post</div>
              <input class="form-field" type="text" name="post" /><br />
              <div class="form-title">Experience</div>
              <select name="experience">
                <option value="oneless">One year or Less</option>
                <option value="twoless">Two years or Less</option>
                <option value="threeless">Three years or Less</option>
                <option value="fourless">Four years or Less</option>
                <option value="fiveless">Five years or Less</option>
                <option value="fivemore">More than Five years</option>
              </select>
